...
After augmentation stage,  samples are converted to spectrograms for input to the model. 
...
| Name                                          | Setting         | $N^o$ Classes | $N^o$ Samples | Format   | Sample Length |
|-----------------------------------------------|-----------------|---------------|---------------|----------|---------------|
| Balanced AudioSet            | Mixed           | 527           | 20,550        | Fixed    | 10s           |
| ESC-50                            | Environmental   | 50            | 2,000         | Fixed    | 5s            |
| NSynt*                        | Instrumentation | 1,006         | 305,978       | Fixed    | 4s            |
